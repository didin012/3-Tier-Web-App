...
````
7. Create a sample HTML server<br>
````
$ echo “PHP Server 1” > index.html
````
8.	**NOTE!!!** Do these commands as well on ```PHP Server 2``` then create another ```index.html``` file inside the ```/var/www/html/``` directory<br>
````
